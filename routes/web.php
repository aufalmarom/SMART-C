...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'user', 'namespace' => '\App\Http\Controllers\User', 'middleware' => 'user'], function () {
        ...
        Route::get('/diridigital/reward', 'UserController@RewardDiriDigital')->name('diridigital.reward.user');
        ...
        Route::get('/jejakdigital/reward', 'UserController@RewardJejakDigital')->name('jejakdigital.reward.user');
        ...
        Route::get('/mengenaliemosi/reward', 'UserController@RewardMengenaliEmosi')->name('mengenaliemosi.reward.user');
        ...
        Route::get('/emosivirtual/reward', 'UserController@RewardEmosiVirtual')->name('emosivirtual.reward.user');
        ...
        Route::get('/cyberbullying/reward', 'UserController@RewardCyberbullying')->name('cyberbullying.reward.user');
        ...
        Route::get('/sumberdukungan/reward', 'UserController@RewardSumberDukungan')->name('sumberdukungan.reward.user');
        ...
        Route::get('/kontroldirilingkaran/reward', 'UserController@RewardKontrolDiriLingkaran')->name('kontroldirilingkaran.reward.user');
        ...
        Route::get('/kontroldirispin/reward', 'UserController@RewardKontrolDiriSpin')->name('kontroldirispin.reward.user');
        ...
        Route::get('/pahlawansmart/reward', 'UserController@RewardPahlawanSmart')->name('pahlawansmart.reward.user');
