...
<body class="bg-sesi1-2">
    <audio id="audio" src="{{asset('public/music/Countdown-Starlight.mp3')}}" autoplay loop>
    </audio>
...
<script id="rendered-js" type="text/javascript" src="{{asset('public/js/sesi.js')}}"></script>
