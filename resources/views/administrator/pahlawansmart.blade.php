...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{route('pahlawansmart.read')}}">Pahlawan SMART</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Pahlawan SMART</h4>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header no-bd justi">
                <h5 class="col-12 modal-title text-center">Delete Data Pahlawan SMART
            ...
            <div class="modal-footer no-bd justify-content-center">
                ...
                <form action="{{route('pahlawansmart.delete')}}" method="post">
                    @csrf
