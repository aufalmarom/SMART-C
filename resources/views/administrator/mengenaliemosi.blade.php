...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{route('mengenaliemosi.read')}}">Mengenali Emosi</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Mengenali Emosi</h4>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="add-row" class="display table table-striped table-hover" >
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th class="text-center">Raut Wajah</th>
                                    <th class="text-center">Mulut</th>
                                    <th class="text-center">Tangan</th>
                                    <th class="text-center">Kaki</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$item->mouth}}</td>
                                    <td class="text-center">{{$item->hand}}</td>
                                    <td class="text-center">{{$item->foot}}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header no-bd justi">
                <h5 class="col-12 modal-title text-center">Delete Data Mengenali Emosi
            ...
            <div class="modal-footer no-bd justify-content-center">
                ...
                <form action="{{route('mengenaliemosi.delete')}}" method="post">
                    @csrf
